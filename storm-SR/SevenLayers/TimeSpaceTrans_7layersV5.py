...
from SevenLayers.transformer.TimeSpaceTransformer import TimeSpaceTransformer_nat
from SevenLayers.SevenLayersV4 import SevenLayersV4, SingleConv
from .utils import initialize_weights


class TimeSpaceTrans_7layers_v5(SevenLayersV4):
    def __init__(
            self,
            img_dim,
            img_time,
        ...
        super(TimeSpaceTrans_7layers_v5, self).__init__(
            img_dim,
            img_time,
            in_channel,
            f_maps=f_maps,
